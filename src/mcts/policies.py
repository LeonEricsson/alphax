...
def muzero_policy(
    ...
    return base.PolicyOutputWithValue(
        action=action,
...
def _make_stochastic_action_selection_fn(
    ...
    def _action_selection_fn(
        key: chex.PRNGKey, tree: search.Tree,
        node_index: chex.Array,
        depth: chex.Array,
    ) -> chex.Array:
        ...
        return jax.lax.cond(
            is_decision, lambda: decision_selection,
